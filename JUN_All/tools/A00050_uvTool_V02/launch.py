...
# A00050_uvTool_V02 - launch entry point (Qt)
#
# UV 세트를 규칙(`map1` 하나)에 맞추는 in-Maya PySide 툴. V01 의 maya.cmds UI 를 옮겼다.
...
def run(reload_module=True):
    ...
    if reload_module and getattr(jun_config, "DEV_MODE", False):
        ...
        reload_for_tool("tools.A00050_uvTool_V02")

    # 리로드 후 갱신된 클래스를 잡기 위해 지역 import.
    from tools.A00050_uvTool_V02.app.ui.main_window import MainWindow, WINDOW_OBJECT_NAME
