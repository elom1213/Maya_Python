...
# A00390_WindTool - launch entry point (Qt)
#
...
def run(reload_module=True):
    ...
    if reload_module and getattr(jun_config, "DEV_MODE", False):
        ...
        reload_for_tool("tools.A00390_WindTool")

    # 리로드 후 갱신된 클래스를 잡기 위해 지역 import.
    from tools.A00390_WindTool.app.ui.main_window import MainWindow, WINDOW_OBJECT_NAME
