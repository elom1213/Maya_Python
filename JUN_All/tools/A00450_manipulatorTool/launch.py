...
# A00450_manipulatorTool - launch entry point (Qt)
#
# 이동/회전/스케일 매니퓰레이터의 축 굵기를 슬라이더로 라이브 조절하는 in-Maya PySide 툴.
...
def run(reload_module=True):
    ...
    if reload_module and getattr(jun_config, "DEV_MODE", False):
        ...
        reload_for_tool("tools.A00450_manipulatorTool")

    # 리로드 후 갱신된 클래스를 잡기 위해 지역 import.
    from tools.A00450_manipulatorTool.app.ui.main_window import MainWindow, WINDOW_OBJECT_NAME
