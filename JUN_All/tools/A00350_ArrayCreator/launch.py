...
# A00350_ArrayCreator - launch entry point (Qt)
#
# 마야 오브젝트를 TSL 에 리스트업하고 UE Control Rig Item Array 노드 텍스트를 생성해
# 클립보드에 복사하는 in-Maya PySide 툴.
...
def run(reload_module=True):
    ...
    if reload_module and getattr(jun_config, "DEV_MODE", False):
        ...
        reload_for_tool("tools.A00350_ArrayCreator")

    # 리로드 후 갱신된 클래스를 잡기 위해 지역 import.
    from tools.A00350_ArrayCreator.app.ui.main_window import MainWindow, WINDOW_OBJECT_NAME
