...
# A00380_MeshTool - UV Sets 표 (A00050_uvTool_V02 v02.02 에서 그대로 이식, v01.17)
#
...
#
# 이 파일은 **Framework 와 Qt 에만** 기대고 툴 코드(창 · 코어)를 import 하지 않는다.
# 행 데이터는 코어 `uv_set_manager.inspect()` 가 만든 dict 목록을 그대로 받는다.
# A00050_uvTool_V02 의 같은 파일과 **내용이 같다** - 한쪽을 고치면 다른 쪽도 맞출 것.
