...
# A00380_MeshTool - MeshDoctor 탭 - 진단 결과를 JSON + 사람이 읽는 TXT 로 0020_out/ 에 저장.
#
...
from tools.A00380_MeshTool.app.config.version import VERSION


# 툴 루트 (.../tools/A00380_MeshTool) - 리포트는 이 툴의 0020_out/ 에 쌓인다.
...
class ReportWriter:
    ...
    def build_txt(self, results):
        lines = []
        lines.append("=" * 70)
        lines.append("  MESH DOCTOR  (A00380_MeshTool v{0}, MeshDoctor tab)".format(VERSION))
