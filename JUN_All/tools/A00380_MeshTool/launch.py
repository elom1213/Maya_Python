...
# A00380_MeshTool - launch entry point (Qt)
#
# 메시 편집 툴 모음. v01.00 은 Peak 탭(노말 방향 팽창/수축) 하나로 시작한다.
...
def run(reload_module=True):
    ...
    if reload_module and getattr(jun_config, "DEV_MODE", False):
        ...
        reload_for_tool("tools.A00380_MeshTool")

    # 리로드 후 갱신된 클래스를 잡기 위해 지역 import.
    from tools.A00380_MeshTool.app.ui.main_window import MainWindow, WINDOW_OBJECT_NAME
