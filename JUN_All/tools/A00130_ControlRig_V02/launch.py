...
# A00130_ControlRig_V02 - launch entry point (Qt)
#
# MEL JointTool V05.03 (Curve / Divide / Aim) + A00060 jointTool (Hair) 병합 툴.
...
def run(reload_module=True):
    ...
    if reload_module and getattr(jun_config, "DEV_MODE", False):
        ...
        reload_for_tool("tools.A00130_ControlRig_V02")

    # 리로드 후 갱신된 클래스를 잡기 위해 지역 import.
    from tools.A00130_ControlRig_V02.app.ui.main_window import MainWindow, WINDOW_OBJECT_NAME
