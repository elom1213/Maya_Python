...
# A00390_WindTool_V03 - launch entry point (Qt)
#
# 리스트업한 본 체인에 싸인 주기함수 키프레임을 찍어 '바람에 일렁이는' 애니메이션을
# 만드는 in-Maya PySide 툴. 주기/진폭/조인트별 offset(실수 프레임)을 지정한다.
...
def run(reload_module=True):
    ...
    if reload_module and getattr(jun_config, "DEV_MODE", False):
        ...
        reload_for_tool("tools.A00390_WindTool_V03")

    # 리로드 후 갱신된 클래스를 잡기 위해 지역 import.
    from tools.A00390_WindTool_V03.app.ui.main_window import MainWindow, WINDOW_OBJECT_NAME
