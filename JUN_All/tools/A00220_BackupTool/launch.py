...
# A00220_BackupTool - standalone launch entry point
#
...
from tools.A00220_BackupTool.app.ui.main_window import MainWindow
from tools.A00220_BackupTool.app.config.app_meta import APP_USER_MODEL_ID, icon_path
...
def main():
    ...
    ThemeManager.load_theme_dev(app, "green_mid")
