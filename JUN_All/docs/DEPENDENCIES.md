...
| **PySide2** | Maya 2022~2024 내장 | ❌ (Maya 제공) | qt.py 폴백, A00008·A00090 직접 import |
...
(아직 직접 import 하는 A00004/08/80/90은 별도 마이그레이션 계획 참고:
`docs/plans/qt_wrapper_migration_plan.md`)
