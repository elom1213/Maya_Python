...
> [!summary] `A00040_file_exporter` v01.01→01.02 — 월드 최상위(부모 없음) 오브젝트 내보내기 에러 수정 + 인덱스 정렬/비교 정리
...
- **문서**: 가이드 [A00040_file_exporter](A00040_file_exporter.md) 신규 작성 + 헤더/타이틀 v01.02.
  Maya 실기 확인 대기.
