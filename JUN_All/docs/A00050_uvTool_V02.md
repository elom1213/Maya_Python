...
>
> **v02.03 기능 그대로 `A00380_MeshTool` 의 `UV Sets` 탭으로 이식됐다**(A00380 v01.17, 2026-09-23).
> 이 툴도 그대로 쓸 수 있다. 두 툴의 `uv_set_manager.py` · `uv_set_table.py` 는 내용이 같다 — 한쪽을 고치면 다른 쪽도 맞출 것.
