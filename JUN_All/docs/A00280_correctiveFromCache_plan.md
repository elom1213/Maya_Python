...
> 작성: 2026-06-24 / 상태: **계획 확정, 구현 전(미착수)**
...
2. **아직 미착수**. `JUN_All/tools/A00280_correctiveFromCache/` 가 없으면 §5 구조대로 A00110 을 클론해 생성.
   (참고 클론 대상: `A00110_animTool` 의 `launch.py`/`__init__.py`/`__dragDrop_A00110.py`/`app/*`.)
