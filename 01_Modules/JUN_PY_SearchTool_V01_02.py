...
def JUN_cmd_Search_By_Token(JUN_name_SearchToken_tfg, JUN_name_SearchTool_SelObjs_tsl, JUN_name_SearchTool_cbg_invertSelect):
...
def PY_JUN_makeUI_SearchTool ():
    ...
    cmds.checkBoxGrp( "JUN_name_SearchTool_cbg_invertSelect", label='Invert Select Type', columnWidth2=(100, 130) , columnAttach2 = ("both", "both") , value1 = False );
    ...
    cmds.button( "name_btn_SelectByType", 
                 ...
                 bgc=color_btn, 
                 command='JUN_cmd_Search_By_Token(\"JUN_name_SearchToken_tfg\", \"JUN_name_SearchTool_SelObjs_tsl\",\"JUN_name_SearchTool_cbg_invertSelect\")');
