# last Update date 25 07 07
# Python Script by Ji Hun Park

# Connect BS tool V01.01
...
def PY_JUN_makeUI_ConnectBS ():
    str_winTitle = "Connect Blendshape Tool";
    str_winName = "Junny_win_ConnectBS_Tools";
    win_width = 480;
    win_height = 900;
    ...
    cmds.window( str_winName, bgc=color_mainDark, title="Connection Tool V01" );
