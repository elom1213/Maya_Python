# last Update date 25 09 23
# Python Script by Ji Hun Park

# Control Rig Tool V01.03
...
class JUN_matcher_v02():
    ...
    def match(self, orient_to_joint=False, jntOrd="xyz", secAxOri="yup", is_leg=False, is_spine__=False):
...
def PY_JUN_makeUI_ContrlRigTool ():
    ...
    cmds.window( str_winName, bgc=color_mainDark, title="Control Rig Tool V01.03" );
...
def JUN_PY_ControlRigTool_V01_03():
