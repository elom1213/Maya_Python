...
class JUN_matcher_FKIK():
    ...
    def set_match_objs(self,
        ...
        if is_match_arm_left:
            ...
            self.flw_all.extend(["l_ArmPole_xx_ctl", "l_ArmIK_xx_ctl", "l_UpperArm_xx_ctl", "l_LowerArm_xx_ctl", "l_Wrist_xx_ctl"])
        ...
        if is_match_arm_right:
            ...
            self.flw_all.extend(["r_ArmPole_xx_ctl", "r_ArmIK_xx_ctl", "r_UpperArm_xx_ctl", "r_LowerArm_xx_ctl", "r_Wrist_xx_ctl"])

        if is_match_leg_left:
            self.tgt_all.extend(["l_LegPole_xx_pos", "l_LegIkPos_xx_pos","l_LegUpIK_xx_pos", "l_LegLowIK_xx_pos", "l_LegAnkleIK_xx_pos", "l_LegFootBallIK_xx_pos"])
            self.flw_all.extend(["l_LegPole_xx_ctl", "l_foot_xx_ctl", "l_UpperLegFK_xx_ctl", "l_LowerLegFK_xx_ctl", "l_ankleFK_xx_ctl", "l_FootFK_xx_ctl"])

        if is_match_leg_right:
            self.tgt_all.extend(["r_LegPole_xx_pos", "r_LegIkPos_xx_pos", "r_LegUpIK_xx_pos", "r_LegLowIK_xx_pos", "r_LegAnkleIK_xx_pos", "r_LegFootBallIK_xx_pos"])
            self.flw_all.extend(["r_LegPole_xx_ctl", "r_foot_xx_ctl", "r_UpperLegFK_xx_ctl", "r_LowerLegFK_xx_ctl", "r_ankleFK_xx_ctl", "r_FootFK_xx_ctl"])
