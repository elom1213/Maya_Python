...
def PY_JUN_makeUI_general_FKIKTool ():
    ...
    cmds.button( "name_btn_setup_rig_name",
                 ...
                 bgc =color_btn,
                 command='JUN_cmd_FKIKTool_setup_btn(\"JUN_name_rig_name_tsl\", \"JUN_text_ctl_FK\", \"JUN_FKIK_targetsPos_tsl\", \"JUN_FKIK_followersCtl_tsl\")');
    ...
    cmds.text( "JUN_text_ctl_FK", height = 20 , align="left", backgroundColor = [1, 1, 1], font = "boldLabelFont",  label='Set ctl : FK' );
    ...
    cmds.frameLayout( label=' Tool : Match IK and FK', collapsable= True, bgc =color_main, h = win_height/2.8 );

    # paneLayout : vertical4(open)                                                      
    ...
    cmds.intFieldGrp( 'name_FKIK_ifg_timeStr', 
                        columnAlign = [1, 'right'], 
                        columnWidth2 = [ win_width/6-15, 230 ], 
