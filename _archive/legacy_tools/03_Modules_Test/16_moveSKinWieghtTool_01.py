...
class JUN_ToolUI_moveSkinWeightTool:
    def __init__(self):
        self.str_winTitle = "move weight tool V01.02 - KG sub tool";
        self.str_headTitle = "move weight tool V01.02 - KG sub tool"
        self.str_winName = "kangaroo_sub_tool_move_weight_tool_v01_02";
        self.win_width = 500;
        self.win_height = 500;
