...
def PY_JUN_makeUI_general_FKIKTool ():
    ...
    tab_ctl_FK_IK = cmds.columnLayout(adjustableColumn=True, 
                                    columnAttach=('both', 5), 
                                    rowSpacing=6, 
                                    bgc =color_mainDark, 
                                    width = 390 );
    ...
    cmds.frameLayout( label='Tool : Setup Ctl', collapsable= True, bgc =color_main );

    cmds.rowLayout( numberOfColumns=1 );

    cmds.text( "JUN_text_ctl_FK", height = 20 , align="left", backgroundColor = [1, 1, 1], font = "boldLabelFont",  label='Set ctl : FK to IK' );
    ...
    cmds.text( "JUN_text_ctl_IK", height = 20 , align="left", backgroundColor = [1, 1, 1], font = "boldLabelFont",  label='Set ctl : IK to FK(left to right order)' );
    ...
    cmds.text( "JUN_FKIK_Gen_title_ctl_IK_pole_arm", align="left", font = "boldLabelFont",  label='Pole Arm' );
    cmds.text( "JUN_name_selNum_ctl_IK_pole_arm", align="left", label='Number:0' );

    str_tls_ctl_IK_pole_arm = "JUN_FKIK_Gen_ctl_IK_pole_arm"
    cmds.textScrollList(str_tls_ctl_IK_pole_arm, 
                        height = (win_height*mult_tsl_ctl_IK_hight),
                        numberOfRows=15, 
                        allowMultiSelection=True, 
                        selectCommand='JUN_cmd_tsl_select(\"JUN_FKIK_Gen_ctl_IK_pole_arm\")');

    cmds.rowLayout( numberOfColumns=4 );

    cmds.button( "NAM_toolSelTgt_b_add",  width= mult_tsl_btn_width_01, label='Add', bgc =color_btn, command=f'CMD_ToolSel_b_add  ( "{str_tls_ctl_IK_pole_arm}", \"JUN_name_selNum_ctl_IK_pole_arm\" )' );
    cmds.button( "NAM_toolSelTgt_b_del",  width= mult_tsl_btn_width_01, label='Del', bgc =color_btn, command=f'CMD_ToolSel_b_del  ( "{str_tls_ctl_IK_pole_arm}", \"JUN_name_selNum_ctl_IK_pole_arm\" )' );
    cmds.button( "NAM_toolSelTgt_b_up",   width= mult_tsl_btn_width_01, label='Up',  bgc =color_btn, command=f'CMD_ToolSel_b_up   ( "{str_tls_ctl_IK_pole_arm}", \"JUN_name_selNum_ctl_IK_pole_arm\" )' );
    cmds.button( "NAM_toolSelTgt_b_down", width= mult_tsl_btn_width_01+15, label='Down',bgc =color_btn, command=f'CMD_ToolSel_b_down ( "{str_tls_ctl_IK_pole_arm}", \"JUN_name_selNum_ctl_IK_pole_arm\" )' );
    ...
    cmds.button( "name_btn_FK_IK_Gen_ctl_fk_pole_arm",
                 label='Select Objects',
                 bgc =color_btn,
                 command=f'JUN_cmd_FKIK_gen_toolSel_btn("{str_tls_ctl_IK_pole_arm}", \"JUN_name_selNum_ctl_IK_pole_arm\")');
    ...
    cmds.text( "JUN_FKIK_Gen_title_ctl_IK_pole_leg", align="left", font = "boldLabelFont",  label='Pole leg' );
    cmds.text( "JUN_name_selNum_ctl_IK_pole_leg", align="left", label='Number:0' );

    str_tls_ctl_IK_pole_leg = "JUN_FKIK_Gen_ctl_IK_pole_leg"
    cmds.textScrollList(str_tls_ctl_IK_pole_leg, 
                        height = (win_height*mult_tsl_ctl_IK_hight),
                        numberOfRows=15, 
                        allowMultiSelection=True, 
                        selectCommand='JUN_cmd_tsl_select(\"JUN_FKIK_Gen_ctl_IK_pole_leg\")');

    cmds.rowLayout( numberOfColumns=4 );

    cmds.button( "NAM_toolSelTgt_b_add",  width= mult_tsl_btn_width_01, label='Add', bgc =color_btn, command=f'CMD_ToolSel_b_add  ( "{str_tls_ctl_IK_pole_leg}", \"JUN_name_selNum_ctl_IK_pole_leg\" )' );
    cmds.button( "NAM_toolSelTgt_b_del",  width= mult_tsl_btn_width_01, label='Del', bgc =color_btn, command=f'CMD_ToolSel_b_del  ( "{str_tls_ctl_IK_pole_leg}", \"JUN_name_selNum_ctl_IK_pole_leg\" )' );
    cmds.button( "NAM_toolSelTgt_b_up",   width= mult_tsl_btn_width_01, label='Up',  bgc =color_btn, command=f'CMD_ToolSel_b_up   ( "{str_tls_ctl_IK_pole_leg}", \"JUN_name_selNum_ctl_IK_pole_leg\" )' );
    cmds.button( "NAM_toolSelTgt_b_down", width= mult_tsl_btn_width_01+15, label='Down',bgc =color_btn, command=f'CMD_ToolSel_b_down ( "{str_tls_ctl_IK_pole_leg}", \"JUN_name_selNum_ctl_IK_pole_leg\" )' );
    ...
    cmds.button( "name_btn_FK_IK_Gen_ctl_fk_pole_leg",
                 label='Select Objects',
                 bgc =color_btn,
                 command=f'JUN_cmd_FKIK_gen_toolSel_btn("{str_tls_ctl_IK_pole_leg}", \"JUN_name_selNum_ctl_IK_pole_leg\")');
    ...
    cmds.text( "JUN_FKIK_Gen_title_ctl_IK_leg_ankle", align="left", font = "boldLabelFont",  label='Leg Ankle' );
    cmds.text( "JUN_name_selNum_ctl_IK_leg_ankle", align="left", label='Number:0' );

    str_tls_ctl_IK_leg_ankle = "JUN_FKIK_Gen_ctl_IK_leg_ankle"
    cmds.textScrollList(str_tls_ctl_IK_leg_ankle, 
                        height = (win_height*mult_tsl_ctl_IK_hight),
                        numberOfRows=15, 
                        allowMultiSelection=True, 
                        selectCommand='JUN_cmd_tsl_select(\"JUN_FKIK_Gen_ctl_IK_leg_ankle\")');

    cmds.rowLayout( numberOfColumns=4 );

    cmds.button( "NAM_toolSelTgt_b_add",  width= mult_tsl_btn_width_01, label='Add', bgc =color_btn, command=f'CMD_ToolSel_b_add  ( "{str_tls_ctl_IK_leg_ankle}", \"JUN_name_selNum_ctl_IK_leg_ankle\" )' );
    cmds.button( "NAM_toolSelTgt_b_del",  width= mult_tsl_btn_width_01, label='Del', bgc =color_btn, command=f'CMD_ToolSel_b_del  ( "{str_tls_ctl_IK_leg_ankle}", \"JUN_name_selNum_ctl_IK_leg_ankle\" )' );
    cmds.button( "NAM_toolSelTgt_b_up",   width= mult_tsl_btn_width_01, label='Up',  bgc =color_btn, command=f'CMD_ToolSel_b_up   ( "{str_tls_ctl_IK_leg_ankle}", \"JUN_name_selNum_ctl_IK_leg_ankle\" )' );
    cmds.button( "NAM_toolSelTgt_b_down", width= mult_tsl_btn_width_01+15, label='Down',bgc =color_btn, command=f'CMD_ToolSel_b_down ( "{str_tls_ctl_IK_leg_ankle}", \"JUN_name_selNum_ctl_IK_leg_ankle\" )' );

    cmds.setParent( '..' )

    cmds.button( "name_btn_FK_IK_Gen_ctl_IK_leg_ankle",
                 label='Select Objects',
                 bgc =color_btn,
                 command=f'JUN_cmd_FKIK_gen_toolSel_btn("{str_tls_ctl_IK_leg_ankle}", \"JUN_name_selNum_ctl_IK_leg_ankle\")');
    ...
    cmds.text( "JUN_FKIK_Gen_title_ctl_IK_leg_toe", align="left", font = "boldLabelFont",  label='Leg Toe' );
    cmds.text( "JUN_name_selNum_ctl_IK_leg_toe", align="left", label='Number:0' );

    str_tls_ctl_IK_leg_toe = "JUN_FKIK_Gen_ctl_IK_leg_toe"
    cmds.textScrollList(str_tls_ctl_IK_leg_toe, 
                        height = (win_height*mult_tsl_ctl_IK_hight),
                        numberOfRows=15, 
                        allowMultiSelection=True, 
                        selectCommand='JUN_cmd_tsl_select(\"JUN_FKIK_Gen_ctl_IK_leg_toe\")');

    cmds.rowLayout( numberOfColumns=4 );

    cmds.button( "NAM_toolSelTgt_b_add",  width= mult_tsl_btn_width_01, label='Add', bgc =color_btn, command=f'CMD_ToolSel_b_add  ( "{str_tls_ctl_IK_leg_toe}", \"JUN_name_selNum_ctl_IK_leg_toe\" )' );
    cmds.button( "NAM_toolSelTgt_b_del",  width= mult_tsl_btn_width_01, label='Del', bgc =color_btn, command=f'CMD_ToolSel_b_del  ( "{str_tls_ctl_IK_leg_toe}", \"JUN_name_selNum_ctl_IK_leg_toe\" )' );
    cmds.button( "NAM_toolSelTgt_b_up",   width= mult_tsl_btn_width_01, label='Up',  bgc =color_btn, command=f'CMD_ToolSel_b_up   ( "{str_tls_ctl_IK_leg_toe}", \"JUN_name_selNum_ctl_IK_leg_toe\" )' );
    cmds.button( "NAM_toolSelTgt_b_down", width= mult_tsl_btn_width_01+15, label='Down',bgc =color_btn, command=f'CMD_ToolSel_b_down ( "{str_tls_ctl_IK_leg_toe}", \"JUN_name_selNum_ctl_IK_leg_toe\" )' );
    ...
    cmds.button( "name_btn_FK_IK_Gen_ctl_IK_leg_toe",
                 label='Select Objects',
                 bgc =color_btn,
                 command=f'JUN_cmd_FKIK_gen_toolSel_btn("{str_tls_ctl_IK_leg_toe}", \"JUN_name_selNum_ctl_IK_leg_toe\")');
    ...
    cmds.text( "JUN_FKIK_Gen_title_ctl_IK_wrist", align="left", font = "boldLabelFont",  label='Wrist' );
    cmds.text( "JUN_name_selNum_ctl_IK_wrist", align="left", label='Number:0' );

    str_tls_ctl_IK_wrist = "JUN_FKIK_Gen_ctl_IK_wrist"
    cmds.textScrollList(str_tls_ctl_IK_wrist, 
                        height = (win_height*mult_tsl_ctl_IK_hight),
                        width = win_width/5-15,
                        numberOfRows=15, 
                        allowMultiSelection=True, 
                        selectCommand='JUN_cmd_tsl_select(\"JUN_FKIK_Gen_ctl_IK_wrist\")');

    cmds.rowLayout( numberOfColumns=4 );

    cmds.button( "NAM_toolSelTgt_b_add",  width= mult_tsl_btn_width_01, label='Add', bgc =color_btn, command=f'CMD_ToolSel_b_add  ( "{str_tls_ctl_IK_wrist}", \"JUN_name_selNum_ctl_IK_wrist\" )' );
    cmds.button( "NAM_toolSelTgt_b_del",  width= mult_tsl_btn_width_01, label='Del', bgc =color_btn, command=f'CMD_ToolSel_b_del  ( "{str_tls_ctl_IK_wrist}", \"JUN_name_selNum_ctl_IK_wrist\" )' );
    cmds.button( "NAM_toolSelTgt_b_up",   width= mult_tsl_btn_width_01, label='Up',  bgc =color_btn, command=f'CMD_ToolSel_b_up   ( "{str_tls_ctl_IK_wrist}", \"JUN_name_selNum_ctl_IK_wrist\" )' );
    cmds.button( "NAM_toolSelTgt_b_down", width= mult_tsl_btn_width_01+15, label='Down',bgc =color_btn, command=f'CMD_ToolSel_b_down ( "{str_tls_ctl_IK_wrist}", \"JUN_name_selNum_ctl_IK_wrist\" )' );
    ...
    cmds.button( "name_btn_FK_IK_Gen_ctl_IK_wrist",
                 label='Select Objects',
                 bgc =color_btn,
                 command=f'JUN_cmd_FKIK_gen_toolSel_btn("{str_tls_ctl_IK_wrist}", \"JUN_name_selNum_ctl_IK_wrist\")');
    ...
    cmds.tabLayout( tab_all, edit=True, tabLabel=((tab_ctl_FK_IK, 'Ctl FK IK'), (tab_drivers, 'Drivers')));
    ...
    cmds.checkBoxGrp( "JUN_name_FKIK_arm_l_cbg", label='Arm Left', columnWidth2=(50, 20) ,columnAlign = (1, "left"), columnAttach2 = ("both", "both") , value1 = True );
    cmds.checkBoxGrp( "JUN_name_FKIK_arm_r_cbg", label='Arm Right', columnWidth2=(50, 20) ,columnAlign = (1, "left"), columnAttach2 = ("both", "both") , value1 = True );
    ...
    cmds.checkBoxGrp( "JUN_name_FKIK_leg_l_cbg", label='Leg Left', columnWidth2=(50, 20) ,columnAlign = (1, "left"), columnAttach2 = ("both", "both") , value1 = True );
    cmds.checkBoxGrp( "JUN_name_FKIK_leg_r_cbg", label='Leg Right', columnWidth2=(50, 20) ,columnAlign = (1, "left"), columnAttach2 = ("both", "both") , value1 = True );
    ...
    lst_ctl = {str_tls_ctl_FK_arm_left,
                    str_tls_ctl_FK_arm_right,
                    str_tls_ctl_FK_leg_left,
                    str_tls_ctl_FK_leg_right,
                    str_tls_ctl_IK_pole_arm,
                    str_tls_ctl_IK_pole_leg,
                    str_tls_ctl_IK_leg_ankle,
                    str_tls_ctl_IK_leg_toe,
                    str_tls_ctl_IK_wrist}
    
    lst_drv = {str_tls_drv_IK_to_FK_arm_left,
                    str_tls_drv_IK_to_FK_arm_right,
                    str_tls_drv_IK_to_FK_leg_left,
                    str_tls_drv_IK_to_FK_leg_right,
                    str_tls_drv_FK_to_IK_pole_arm,
    ...
    cmds.button( "name_btn_setup_all_pose_objects", 
                 label='Set up all pose objects', 
                 bgc=color_btn, 
                 command=lambda *argv : JUN_cmd_FKIK_gen_setup_all_pos_objs());
    
    cmds.button( "name_btn_create_pose_objects", 
                 label='Create pose objects', 
                 bgc=color_btn, 
                 command=lambda *argv : JUN_cmd_FKIK_gen_create_pos_objs());
    
    cmds.button( "name_btn_constraint_pose_objects", 
                 label='Constraint pose objects', 
                 bgc=color_btn, 
                 command=lambda *argv : JUN_cmd_FKIK_gen_con_pos_objs());
    ...
    cmds.button( "name_btn_bake_IK", 
                 ...
                 label='Bake IK', 
                 bgc=color_btn, 
                 command='JUN_cmd_bake_IK_FK(\"JUN_FKIK_gen_targetsPos_tsl\", \"JUN_FKIK_gen_followersCtl_tsl\",\"JUN_name_FKIK_arm_l_cbg\",\"JUN_name_FKIK_arm_r_cbg\", \"JUN_name_FKIK_leg_l_cbg\",\"JUN_name_FKIK_leg_r_cbg\", 1, \"name_FKIK_gen_ifg_timeStr\", \"name_FKIK_gen_ifg_timeEnd\")');

    cmds.button( "name_btn_bake_FK", 
                 h = win_height/40,
                 label='Bake FK', 
                 bgc=color_btn, 
                 command='JUN_cmd_bake_IK_FK(\"JUN_FKIK_gen_targetsPos_tsl\", \"JUN_FKIK_gen_followersCtl_tsl\",\"JUN_name_FKIK_arm_l_cbg\",\"JUN_name_FKIK_arm_r_cbg\", \"JUN_name_FKIK_leg_l_cbg\",\"JUN_name_FKIK_leg_r_cbg\", 0, \"name_FKIK_gen_ifg_timeStr\", \"name_FKIK_gen_ifg_timeEnd\")');
