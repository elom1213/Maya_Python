...
def PY_JUN_makeUI_copyNameUI ():
    ...
    cmds.window( str_winName, bgc=color_mainDark, title="Naming Tool V01" );
    ...
    cmds.button( 
                    ...
                    bgc = color_btn,
                    command='JUN_cmd_rename_for_dyn ( \"name_toolSelBase_NamingDyn_tsl\", \"namingDyn_tf_dyn\", \"namingDyn_tf_asset\", \"namingDyn_tf_sid\", \"namingDyn_tf_index_01\", \"namingDyn_tf_index_02\") '                     
                    ); 
