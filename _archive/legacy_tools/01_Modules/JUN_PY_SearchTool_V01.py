...
def JUN_cmd_Search_By_Token(JUN_name_SearchToken_tfg, JUN_name_toolSelObjs_tsl, JUN_name_toolSel_cbg_invertSelect):
    ...
    cmds.textScrollList( JUN_name_toolSelObjs_tsl, e=True, selectItem=search_result);
...
def PY_JUN_makeUI_SearchTool ():
    ...
    cmds.button( "name_btn_SelectByType", 
                 ...
                 bgc=color_btn, 
                 command='JUN_cmd_Search_By_Token(\"JUN_name_SearchToken_tfg\", \"JUN_name_toolSelObjs_tsl\",\"JUN_name_toolSel_cbg_invertSelect\")');
