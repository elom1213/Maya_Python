# last Update date 26 01 06
# Python Script by Ji Hun Park

# Copy Key Tool V03.01

# 03.01     update pastekey option from "replaceCompletely to insert"
...
def JUN_cmd_copyKey_V02(str_selTool_tsl_base,
    ...
    for i in range(0, int_num_base):
        ...
        try:
            cmds.pasteKey(tgt_current, option="insert");
...
def PY_JUN_makeUI_copyKeyUI ():
    ...
    str_winName = "Junny_win_CopyKey_Tools_V03__01";
    win_width = 480;
    win_height = 700;
    ...
    cmds.window( str_winName, bgc=color_mainDark, title="Copy Key Tool V03.01" );
