...
- A00050 — [uvTool V02](wip-a00050-uvtool-v02.md)(V01 PySide 이식 · 규칙 위반을 사유와 함께 로그+선택 · rename 은 before->after 와 실패 사유, v02.00 · 바꿀 세트 이름을 화면에서 입력, 칸 하나가 Catch 의 규칙도 정한다, v02.01 · UV Sets 표 + `[wrong_name]` 빨강, **A00380 으로 이식 예정**(표 파일+코어 그대로), v02.02)
