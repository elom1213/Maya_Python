...
- A00400 — [CurveTool](wip-a00400-curvetool.md) · [Smooth](wip-a00400-smooth-tab.md)(닫힌 커브 우회, v01.09) · [Points to Curve](wip-a00400-points-to-curve.md) · [Wrap](wip-a00400-curve-wrap.md) · [Joints](wip-a00400-curve-joints.md)(v01.14 NURBS 서피스 U/V 한 줄) · [Controls](wip-a00400-controls-tab.md)(bs_controls 이식, v01.15) · Combine(v01.11, 쉐입 복사 합치기 — [instance trap](parent-shape-add-is-instance.md)) · [Shape Transform](wip-a00400-shape-transform.md)(셰이프 CV 를 피벗 기준 scale/move/rotate, 트랜스폼 채널 불변, v01.18 · 값 9개 전부 슬라이더 + 범위 밖 값이면 슬라이더 범위를 넓힌다, v01.19 · 라이브 세션 = CV 원위치에서 매번 재계산 + 드래그 한 번에 undo 한 번, v01.20)
