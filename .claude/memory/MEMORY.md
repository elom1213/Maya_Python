...
- A00130 V02 — [Match](wip-a00130-v02-match.md)(NS 양쪽 탐색 · 부모부터 맞추고 밀려난 것은 재매칭, v02.20 · Check Position 초록/빨강, v02.21 · 행 더블클릭 set 선택, v02.23) · [Length](wip-a00130-length-values.md) · [IK session](wip-a00130-ik-session.md)(snapEnable 이 undo 를 깬다) · [Orient & Place](wip-a00130-orient.md)(쇄골 aim_at · 왼쪽만 주면 이른 미러 탓에 오른쪽이 어긋남, v02.24) · [Pair & Constrain](wip-a00130-pair-constrain.md)(parentConstraint 가 조용히 타깃을 늘린다, v02.17) · [IK axis](wip-a00130-ik-axis.md)(`twist` 로만)
