...
description: A00170 Stretch tab — additive set-driven-key stretch driver from ref_01_StretchTool.mel (DONE, Maya-verified + pushed v01.09)
metadata: 
  node_type: memory
  type: project
...
**Status**: DONE — core headless-verified (incl. additive offset: per-object original preserved, disconnect-surgery keeps infinity) + **Maya real-env confirmed by user** + pushed v01.09 ([[push-target-dnable-dev]], [[push-includes-tool-guide-docs]] — guide `docs/A00170_driverTool.md` = 4 tabs, version.py 01.09, WORKLOG updated). See [[wip-a00170-attachcrv-tab]] for the sibling tab pattern.
